...
public class KategoriTypeAdapter extends RecyclerView.Adapter<KategoriTypeAdapter.HolderData> {
    ...
    public KategoriTypeAdapter(Context ctx, List<Kategori> mList, OnItemClickListener mOnItemClickListener) {
        this.mList = mList;
        this.ctx = ctx;
    ...
    public void onBindViewHolder(HolderData holder, final int position) {
        ...
        holder.tvNama.setText(model.getNama_tipe());
